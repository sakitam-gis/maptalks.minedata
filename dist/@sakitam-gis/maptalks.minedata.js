...
MineLayer.registerRenderer('dom', function () {
    ...
    _class.prototype._createLayerContainer = function _createLayerContainer() {
        var container = this._container = maptalks.DomUtil.createEl('div', 'maptalks-minelayer');
...
exports.MineLayer = MineLayer;

Object.defineProperty(exports, '__esModule', { value: true });

typeof console !== 'undefined' && console.log('@sakitam-gis/maptalks.minedata v0.0.1, requires maptalks@^0.40.4.');
